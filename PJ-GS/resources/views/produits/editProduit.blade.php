        ...
        <span class="align-middle">Déconnexion</span>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Modifier/</span> Produit</h4>
                    ...
                    <div class="card-body">
                      <form action="{{route('produits.update',$produit->id)}}" method="post">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="nom" placeholder="Entrer le nom de Produit" value="{{$produit->nom}}" />
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-email">Prix Unitaire</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                class="form-control"
                                name="prix"
                                placeholder="prix Unitaire de produits"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">Categorie</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              ...
                              name="categorie"
                              placeholder="Entrer le Categorie"
                              value="{{$produit->categorie}}"
                               />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">Quantite</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              id="basic-default-phone"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">Date Entree</label>
                          <div class="col-sm-10">
                            <input
                              type="date"
                              id="basic-default-phone"
                              class="form-control phone-mask"
                              name="dateEntre"
                              placeholder="Entrer la date de Entree"
                              value="{{$produit->DateEntree}}"
                               />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">Date Fabrication</label>
                          <div class="col-sm-10">
                            <input
                              type="date"
                              id="basic-default-phone"
                              ...
                              placeholder="Entrer la date de Fabrication"
                              value="{{$produit->DateFabrication}}"
                               />
                          </div>
                        </div>
