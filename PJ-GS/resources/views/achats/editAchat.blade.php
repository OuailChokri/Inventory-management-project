        ...
        <span class="align-middle">Déconnexion</span>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Modifier/</span> Achat</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{route('achats.update',$achat->id)}}" method="post">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="clientSelect">Fournisseur</label>
                            <div class="col-sm-10">
                                <select disabled="true" id="clientSelect" name="nomFournisseur" class="form-select">
                                    <option value="{{ $achat->fournisseur_nom }}">{{ $achat->fournisseur_nom }}</option>
                                </select>
                            </div>
                        </div>
                       <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="produitSelect">Produit</label>
                            <div class="col-sm-10">
                                <select disabled="true" id="produitSelect" name="nomProduit" class="form-select">
                                    <option  value="{{ $achat->produit_nom }}">{{ $achat->produit_nom}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Quantite</label>
                          <div class="col-sm-10">
                            <input
                              type="number"
                              class="form-control"
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-email">Prix</label>
                          <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">Date Achat</label>
                          <div class="col-sm-10">
                            <input
                              type="date"
