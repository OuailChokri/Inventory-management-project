        ...
        <span class="align-middle">Déconnexion</span>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Modifier/</span> Fournisseur</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{route('fournisseurs.update',$fournisseur->id)}}" method="post">
                        @csrf
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Nom</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              class="form-control"
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              id="basic-default-company"
                              name="telephone"
                              placeholder="Entrer le numero de telphone"
                              value="{{$fournisseur->téléphone}}"
                              />
                          </div>
                        </div>
                        <div class="row mb-3">
