        ...
        <div class="col-12">
            <div class="card mx-auto"> <!-- Ajouter la classe mx-auto -->
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 text-capitalize">Ventes data</h5>
                    <div>
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSaleModal">Ajouter Vente</button>
                    </div>
                </div>
                    ...
                    <table id="clients-table" class="display w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="badge bg-label-success" style="margin-top:15px;">{{$vente->quantite}}</td>
                                <td class="text-primary">{{$vente->prix}}</td>
                                <td>{{$vente->date_vente}}</td>
                                <td class="action-buttons">
    <div class="d-flex align-items-center">
        <a href="{{ route('ventes.edit', $vente->id) }}" class="btn btn-edit btn-sm me-2">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addSaleModalLabel">Ajouter Vente</h5>
                <div class="logo-container" style="padding-left:10px;">
                    <img src="./images/vente.png" alt="Logo" class="modal-logo">
                </div>
            ...
            <div class="modal-body">
                <form action="{{ route('ventes.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="produitSelect" name="nomProduit" class="form-select">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="prix" name="prix" placeholder="Prix calculé automatiquement" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="dateVente" class="form-label">Date Vente</label>
                        <input type="date" class="form-control" id="dateVente" name="dateVente" placeholder="Entrer la date de Vente">
                    </div>
