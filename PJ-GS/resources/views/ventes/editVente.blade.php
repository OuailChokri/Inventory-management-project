        ...
        <span class="align-middle">Déconnexion</span>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Ajouter/</span> Vente</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{route('ventes.update',$vente->id)}}" method="post">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="clientSelect">Client</label>
                            <div class="col-sm-10">
                                <select id="clientSelect" name="nomClient" class="form-select">
                                    <option value="{{ $vente->client_nom }}">{{ $vente->client_nom }}</option>
                                </select>
                            </div>
                        </div>
                       <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select id="produitSelect" name="nomProduit" class="form-select">
                                    <option value="{{ $vente->produit_nom }}">{{ $vente->produit_nom }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">Date Vente</label>
                          <div class="col-sm-10">
                            <input
                              type="date"
                              ...
                              name="dateVente"
                              placeholder="Entrer la date de Vente"
