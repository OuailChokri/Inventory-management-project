        ...
        <span class="align-middle">Déconnexion</span>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Ajouter/</span> Client</h4>
                    ...
                    <div class="card-body">
                      <form action="{{route('clients.store')}}" method="post">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="nom" placeholder="Entrer le nom" />
                          </div>
                        </div>
                        <div class="row mb-3">
