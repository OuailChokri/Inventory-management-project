  ...
  <body>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                <a class="dropdown-item" href="{{asset('/achats')}}">View More</a>
                            </div>
                        </div>
                    </div>
                    <span class="fw-medium d-block mb-1">Total Achats</span>
                    <h3 class="card-title text-nowrap mb-1">{{$totalAchats}} DH</h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                <a class="dropdown-item" href="{{asset('/clients')}}" >View More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                <a class="dropdown-item" href="{{asset('/ventes')}}">View More</a>
                            </div>
                        </div>
                    </div>
                    <span class="d-block mb-1">Total Revenue</span>
                    <h3 class="card-title text-nowrap mb-2">{{$totalRevenue}} DH</h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                <a class="dropdown-item" href="{{asset('/produits')}}">View More</a>
                            </div>
                        </div>
                    </div>
                    <span class="fw-medium d-block mb-1">Produit En Stock</span>
                    <h3 class="card-title mb-2">{{$produitsEnStock}}/{{$countProduits}}</h3>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 text-capitalize">Ventes Récente</h5>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-borderless table-hover mb-0">
                    <thead>
                        <tr class="text-center"> <!-- Ajout de la classe text-center -->
                    ...
                    <tbody>
                      @foreach($recentVentes as $recentVente)
                        <tr class="text-center"> <!-- Ajout de la classe text-center -->
                            <td>{{$recentVente->client_nom}}</td>
                            <td>{{$recentVente->produit_nom}}</td>
                            <td class="text-warning">{{$recentVente->quantite}}</td>
                            <td class="text-success">{{$recentVente->prix}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
<div class="col-lg-6">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 text-capitalize">Clients Récente</h5>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-borderless table-hover mb-0">
                    ...
                    <tbody>
                      @foreach($recentClients as $recentClient)
                        <tr class="text-center"> 
                            <td>{{$recentClient->nom}}</td>
                            <td  class="text-primary">{{$recentClient->email }}</td>
                            <td class="text-success" >{{$recentClient->téléphone}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
<div class="container mt-3">
    <!-- Table 2 -->
    <div class="row justify-content-center" style="padding-bottom:1%;"> <!-- Centrer la ligne -->
        <div class="col-12">
            <div class="card mx-auto"> <!-- Ajouter la classe mx-auto -->
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 text-capitalize">Derniers produits arrivés dans notre stock</h5>
                </div>
                <div class="d2c_dataTable table-responsive text-center">
                    <table id="clients-table" class="display w-100">
                        ...
                        <tbody>
                        <tr>
                          @foreach($recentAchats as $recentAchat)
                            <td>{{$recentAchat->id}}</td>
                            <td>{{$recentAchat->produit_nom}}</td>
                            <td>{{$recentAchat->fournisseur_nom}}</td>
                            <td>{{$recentAchat->quantite}}</td>
                            <td>{{$recentAchat->prix}}</td>
                            <td>{{$recentAchat->date_achat}}</td>
                            <td>
                                                @if($recentAchat->quantite > 0)
                                                    <span style="font-size: 13px;" class="badge bg-label-success me-1">Disponible</span>
                                                @else
                                                    <span style="font-size: 13px;" class="badge bg-label-danger me-1">{{$recentAchat->status}}</span>
                                                @endif
                            </td>
                        </tr>
                        @endforeach
