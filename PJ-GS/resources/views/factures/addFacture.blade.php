            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Nouvelle Facture</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('factures.store') }}" method="post">
                            @csrf
                            <div class="row mb-3">
    <label class="col-sm-2 col-form-label fs-6 fw-bold" for="clientSelect">Client</label>
    <div class="col-sm-10">
        <select id="clientSelect" name="nomClient" class="form-select select2">
...
<div class="row mb-3">
    <label class="col-sm-2 col-form-label fs-6 fw-bold" for="ventesSelect">Ventes</label>
    <div class="col-sm-10">
...
<script>
    $(document).ready(function() {
        ...
        $('#clientSelect').change(function() {
            ...
            // Disable the ventes select and clear any existing options
                    ...
                    success: function(data) {
                        if (data.ventes && data.ventes.length > 0) {
                            data.ventes.forEach(function(vente) {
                                var option = new Option(`${vente.id} - ${vente.produit_nom} - ${vente.prix}`, vente.id, false, false);
                                ventesSelect.append(option);
                            });
                            ventesSelect.prop('disabled', false);
                        }
                    },
