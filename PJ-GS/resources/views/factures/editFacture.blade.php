        ...
        <span class="align-middle">Déconnexion</span>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Ajouter/</span> Facture</h4>
                    ...
                    <div class="card-body">
                      <form action="{{route('factures.update',$facture->id)}}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select disabled="true" id="clientSelect" name="nomClient" class="form-select">
                                    <option value="{{ $facture->client_nom }}">{{ $facture->client_nom }}</option>
                                </select>
                            </div>
                        </div>
                       <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="produitSelect">Id ventes</label>
                            <div class="col-sm-10">
                                <select disabled="true" id="produitSelect" name="idVente" class="form-select">
                                    <option value="{{ $facture->vente_id }}">{{ $facture->vente_id }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Total</label>
                          <div class="col-sm-10">
                            <input
                              type="number"
                              class="form-control"
